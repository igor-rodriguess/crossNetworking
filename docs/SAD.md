...
seção 9 — a intenção é que este texto seja utilizável por quem for operar,
...
|---|---|---|
| Frontend | React 18, TypeScript, Vite 5, Tailwind 3, Zustand | ~13,4 mil linhas |
| Backend | Node, Express 4, TypeScript, Zod, pino | ~17,3 mil linhas |
| Banco | PostgreSQL 16 (Supabase), pgvector | 52 migrations |
| Testes | Vitest (backend e frontend), Testing Library | 203 + 27 casos |
| IA | Ollama (local), DeepSeek, OpenAI (embeddings), Firecrawl | todos opcionais |
